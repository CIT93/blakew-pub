...
// localStorage.setItem(LOCAL_STORAGE_KEY, "Blake");
...
export const saveEntries = function(entries) {
    ...
    // localStorage can only store strings. We must convert our JavaScript array of objects into a JSON string using JSON.stringify() before saving.
